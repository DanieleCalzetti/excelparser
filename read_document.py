...
class read_document:
    ...
    def find_header(self, coverage_header, like_header, row_header, impression_header, hashtag_header):
        ...
        self.column_coverage, self.column_hashtag, self.column_like, self.column_hashtag= "", "", "", ""
    ...
    def find_top_post(self):
        ...
        for num in self.row_in_use:
            coverage_value = self.sheet["".join([self.column_coverage, str(num)])].value
            ...
            impression_value = self.sheet["".join([self.column_impression, str(num)])].value
    ...
    def compare_hashtag(self):
        hashtags_max_coverage = list(self.sheet["".join([self.column_hashtag, str(self.row_max_coverage)])].value.split())
        hashtags_max_like = list(self.sheet["".join([self.column_hashtag, str(self.row_max_like)])].value.split())
        hashtags_max_impression = list(self.sheet["".join([self.column_hashtag, str(self.row_max_impression)])].value.split())
